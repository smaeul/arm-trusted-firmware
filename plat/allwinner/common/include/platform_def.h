...
#define BL31_BASE			(SUNXI_DRAM_BASE + 0x4000)
#define BL31_LIMIT			(SUNXI_DRAM_BASE + 0x70000)
#define SUNXI_SCP_BASE			(SUNXI_SRAM_A2_BASE + 0x4000)
#define BL31_NOBITS_BASE		(SUNXI_DRAM_BASE + 0x11000)
#define BL31_NOBITS_LIMIT		(SUNXI_DRAM_BASE + 0x20000)

#define MAX_XLAT_TABLES			4
#define PLAT_VIRT_ADDR_SPACE_SIZE	(1ULL << 32)

#ifdef SUNXI_DRAM_VIRT_BASE
#undef SUNXI_DRAM_VIRT_BASE
#endif
