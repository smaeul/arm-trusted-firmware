...
#define BL31_BASE			(SUNXI_SRAM_A2_BASE + 0x5000)
#define BL31_LIMIT			(SUNXI_SRAM_A2_BASE + SUNXI_SRAM_A2_SIZE)

#define BL31_DYN_BASE			SUNXI_SRAM_A1_BASE
#define BL31_DYN_LIMIT			(SUNXI_SRAM_A1_BASE + SUNXI_SRAM_A1_SIZE)
...
#define PLAT_CSS_SCP_COM_SHARED_MEM_BASE (SUNXI_SRAM_A2_BASE + 0x4e00)
